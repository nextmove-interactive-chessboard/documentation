...
\begin{itemize}
    \item Visual Studio Code: Ein leistungsstarker Code-Editor, der die Entwicklung von Webanwendungen erleichtert.
    \item Python: Die Hauptprogrammiersprache für die Backend-Entwicklung.
    \item Flask: Ein leichtgewichtiges Webframework für Python, das die Entwicklung von Webanwendungen erleichtert.
    \item MySQL: Ein relationales Datenbankmanagementsystem, das zur Speicherung der Spieldaten verwendet wird.
