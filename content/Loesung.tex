...
% Nur Footer für deinen Teil:
\ofoot*{Christoph Schwaninger}

% Kapitel-Startseiten sollen NICHT "plain" sein:
\makeatletter
\let\origchapter\chapter
\renewcommand{\chapter}{%
  \@ifstar{\origchapter*}{\@dblarg\chapter@nostar}%
}
\newcommand{\chapter@nostar}[2][]{%
  \origchapter[#1]{#2}%
  \thispagestyle{scrheadings}% <-- erzwingt Header auch auf der Kapitel-Startseite
}
\makeatother
...
\[
R_{PU} = \frac{3{,}3\,V - 0{,}2\,V}{0{,}001\,A} = 2{,}9\,k\Omega
\]
...
Pull-Up Widerstand & 2 & 3,3 k$\Omega$ \\ \hline
\end{tabular}
...
\begin{minipage}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/PlatinenPrototyp2.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\paperwidth]{figures/8x8Matrix.png}
