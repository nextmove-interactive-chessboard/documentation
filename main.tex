...
\newcommand{\mytitle}{Nextmove} 
\newcommand{\mysubtitle}{Interaktives Schachbrett}
\newcommand{\myinstitute}{Abteilung Elektronik und technische Informatik} 
\newcommand{\mysubmissionyear}{2026} %% Einreich - Jahr
\newcommand{\mysubmissionmonth}{März} %% Monat der Einreichung
\newcommand{\myauthor}{Maximilian Koch\\Christoph Schwaninger\\Christina Seidner}  %% Autoren. Bitte mit \\ Trennen wenn mehrere
\newcommand{\mysupervisor}{Schiechtl Kevin, Dipl. -Ing. (FH)\\Götsch Leopold, DI}  %%Betreuer. Bitte mit \\ Trennen wenn mehrere
 \newcommand{\myprojectpartner}{\mbox{}}
...
\usepackage{adjustbox} % für die Anpassung von Bildern und Code-Listings an die Textbreite
...
\newpage
\input{content/Loesungsidee}% Einfach auskommentieren für die tatsächliche Arbeit
\newpage
\input{content/Loesung}
\newpage
\newpage

%%\input{content/latex_beispiele} 
...
%%\chapter{Appendix}
\renewcommand{\myauthor}{Maximilian Koch\\Christoph Schwaninger\\Christina Seidner}  %% Autoren. Bitte mit \\ Trennen wenn mehrere
...
\newpage
\renewcommand{\myauthor}{Maximilian Koch\\Christoph Schwaninger\\Christina Seidner}
\lstlistoflistings
